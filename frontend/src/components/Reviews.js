  ...
  return (
    <>
      <div className="bg-transparent p-5 rounded-lg flex flex-col justify-start items-start ">
        <div className="overflow-y-scroll h-96 w-full p-2 scrollbar">
        ...
        {props._id ? (
          <>
            <div className="flex flex-wrap items-stretch w-full relative h-15 bg-white rounded-lg mb-4 mt-3">
              <label className="flex -mr-px justify-center w-15 p-2">
          ...
          : <div className="flex flex-wrap items-stretch w-full relative h-15 bg-white rounded-lg mb-4 mt-3 cursor-not-allowed">
            <label className="flex -mr-px justify-center w-15 p-2">
              <span className="flex items-center cursor-not-allowed leading-normal  rounded rounded-r-none text-xl whitespace-no-wrap text-gray-600">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6"
                  fill="none"
            ...
            <input
              disabled
              type="text"
              className="flex-shrink flex-grow text-gray-900 bg-white rubik leading-normal w-px  border-0 cursor-not-allowed h-10 border-grey-light px-3 self-center relative  font-roboto text-base outline-none placeholder-gray-600"
              placeholder="Sign in for write your review"
            />
            <div className="flex -mr-px bg-white  rounded-r-lg">
              <span
                className="flex items-center leading-normal border-0 px-3 whitespace-no-wrap text-gray-900"
              ...
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 cursor-not-allowed rotate-90"
                  viewBox="0 0 20 20"
                  fill="#111827"
                >
                  <path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5-1.429A1 1 0 009 15.571V11a1 1 0 112 0v4.571a1 1 0 00.725.962l5 1.428a1 1 0 001.17-1.408l-7-14z" />
